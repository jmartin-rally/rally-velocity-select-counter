Ext.define('CustomApp', {
    ...
    allRelease: "--ANY--",
    items: [
        {xtype:'container',itemId:'selector_box', layout: { type: 'vbox' }},
        {xtype:'container',html:'To generate velocities across sprints in a release, pick the release from the release dropdown, and the respective start sprint from the start sprint dropdown and ' +
                'the respective end sprint from the end sprint dropdown. <br/><br/> ' +
                'If you want to generate velocities across sprints across releases, pick "ANY" ' +
                'value from the release dropdown, and then the respective start sprint from the start sprint dropdown and the respective end sprint from the end sprint dropdown.'},
